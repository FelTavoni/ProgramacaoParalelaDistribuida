/*
 * Code provided by the Mackenzie Marathon.
 * Some comments for further understanding of the code were added.
 *
...
int main (int ac, char **av){
  ...
  //printf("p(%u, %u, %u)\n", npX, npY, npZ);
  //Allocing memory
  // A 3-dimensional grid, used to build the cube.
  // u0 is the ___.
  // u1 is the ___.
